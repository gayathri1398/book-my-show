    ...
    return (
        ...
        <div className="flex flex-col items-start gap-3  md:gap-5 p-1 lg:gap-10  ">
            ...
            <div className="flex flex-col-reverse lg:flex-col ">
                <div className="text-white w-full h-16 text-xs  md:text-md flex flex-col gap-2 lg:gap-5">
                    <h1 className="hidden lg:block font-bold text-4xl">Zack Snyder`s Justice League</h1>
                    <h3 className="text-gray-300"> English  &bull;  Language: Audio(1), Subtitle(1)</h3>
                    <h3 className="w-full"> 4h 1m &bull; Fantasy, Action, Adventure &bull; 16+ &bull; 18 Mar,2021</h3>
                </div>
